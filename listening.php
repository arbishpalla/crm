...
$query_main = "SELECT a.description, a.package_id, b.user_name,c.package_name FROM query a, form b, package c
  ...
  <div class="container-fluid"> 
    ...
    <?php
                                    	while($row = mysqli_fetch_assoc($result_main))
											...
											<a href='#' class='btn mini black'><i class='icon-edit'></i> Update</a></td></tr>";
