<?php 
	...
	if($_POST)
	{
		...
		*/
		...
		$query_extra = "INSERT INTO `query`(`user_id`, `emp_id`, `package_id`, `time_stamp`, `description`) VALUES ('$user_id','$emp_id','$packageID',now(),'$description')"
		or die ('sorry there is an error in login Insert code');
               ...
               <div class="span12">
                  ...
                  <div class="btn-group">
                    <button onclick="addInput()" type="button" class="btn green"> Add New <i class="icon-plus"></i> </button>
                         ...
                         <label id="'+boxName+'" class="control-label">Username</label>
                          <div class="control-group">
                         <input required name="package_name"id="'+boxName+'" type="text" class="span6"/>
                         </div>                        
                           <div class="control-group">
                              <label class="control-label">Description</label>
                              <div class="controls">
                                 <textarea required name="description" id="showDescription" class="span6 " rows="3"></textarea>
